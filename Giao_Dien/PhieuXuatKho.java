        ...
        try {
            ...
            if (rs.next()) {
                if (rs.getInt("SoLuong") > soLuong) {
                    return 1;
                } else if (rs.getInt("SoLuong") < soLuong) {
                    return -1;
                } else {
                    return 0;
                }
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(PhieuMoi, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(43, 43, 43))
        );
...
//            txtThanhTien.setText(Table.getValueAt(selectedRow,5).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        if (kiemTraSLSP(txtMaSP.getText(), Integer.parseInt(txtSoLuong.getText())) == 1)
            chinhSuaSL(txtMaSP.getText(), Integer.parseInt(txtSoLuong.getText()));
