 ...
 * @author ASUS
 */
public class ChiTietXuat extends javax.swing.JPanel {
      DefaultTableModel model;
    private ArrayList<SoCTXuat> listXuat;
    public ChiTietXuat() {
        initComponents();
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(txtTenNN, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtDVT)))
        ...
        Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Số thứ tự", "Thời gian giao dịch", "Mã phiếu", "Mã nhân viên lập phiếu", "Tên người nhận", "Mã sản phẩm", "Đơn vị tính", "Số lượng ", "Đơn giá"
            }
        ) {
        ...
        cbxFind.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Thời gian giao dịch", "Mã phiếu", "Mã sản phẩm", "Mã nhân viên" }));
    ...
    private void loadAll(String dk){
        ...
        if (txtTimeGD.getText().equals("")) {
            ...
            return false;
        } else if (txtTenNN.getText().equals("")) {
            JOptionPane.showConfirmDialog(this, "Chưa nhập tên người nhận");
    ...
    public void showResult() {
            for(SoCTXuat xuat : listXuat){
                 model.addRow(new Object[]{i++,xuat.getTimeGD(),xuat.getMaPhieu(),xuat.getMaNV(),xuat.getTenNN(),xuat.getMaSP(),xuat.getDVT(),xuat.getSoLuong(),xuat.getDonGia() });
            }
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        if (checkNull()) {
          try{
            ...
            Chi_TietXuatDAO dao = new Chi_TietXuatDAO();
            dao.insert(xuat);
            listXuat.add(xuat);
            showResult();
            listXuat.remove(xuat);
          }
          catch(Exception ex){
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        if (selectedRow >= 0) {
            ...
            txtTenNN.setText(Table.getValueAt(selectedRow, 4).toString());
